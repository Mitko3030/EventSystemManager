...
namespace EventSystemManager.Tests
{
    ...
    public class EventServiceTests
    {
        ...
        public async Task AddAsync_Throws_WhenTitleIsMissing()
        {
            ...
            await Assert.ThrowsExceptionAsync<DbUpdateException>(() => service.AddAsync(ev));
        }
    ...
    public class EventModelTests
    {
        ...
        {
            var specificDate = new DateTime(2026, 6, 15, 18, 0, 0);
            var ev = new Event
            {
                Title = "Concert",
                Date = specificDate,
    ...
    public class AdditionalRegistrationTests
    {
        ...
        public async Task DeleteAsync_DeletesCorrectRegistration_WhenThereAreMultiple()
        {
            ...
            var ev1 = new Event { Title = "Event 1", Description = "Desc", Date = DateTime.Now, Location = "Burgas" };
            var ev2 = new Event { Title = "Event 2", Description = "Desc", Date = DateTime.Now, Location = "Varna" };

            var participant1 = new Participant { FirstName = "Ivan", LastName = "Ivanov", Email = "ivan@test.com" };
            var participant2 = new Participant { FirstName = "Maria", LastName = "Petrova", Email = "maria@test.com" };
